    ...
    <SectionWrapper id="fleet" className={styles.section}>
      <div className="container">
        <div className={styles.titleGroup}>
          <h2 className={styles.title}>Nuestra Flota</h2>
          <p className={styles.subtitle}>
            Vehículos premium equipados con el máximo confort para garantizar un viaje seguro e impecable.
          </p>
        </div>
            ...
            [
              {
                ...
                desc: "Sedán ejecutivo, amplio y confortable",
                image: "/images/toyota-corolla.jpg",
                badge: "Habilitado GCBA"
              },
              {
                model: "Renault Kangoo",
                desc: "Ideal para grupos y equipaje extra",
                image: "/images/renault-kangoo.jpg",
                badge: "Habilitado GCBA"
              },
              {
                model: "Chevrolet Spin",
                desc: "7 pasajeros, perfecto para familias",
